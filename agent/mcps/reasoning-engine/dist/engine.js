...
export class ThesisAntithesisEngine {
    ...
    processPhase(input) {
        ...
        switch (phase) {
            ...
            case "antithesis": {
                ...
                if (session.thesis) {
                    contradictions = detectContradictions(session.thesis.assumptions, session.antithesis.attacks);
                    session.contradictions = contradictions;
                    // Count survived assumptions
                    countSurvivedAssumptions(session.thesis.assumptions, session.antithesis.attacks);
                }
                break;
            }
            case "synthesis": {
    ...
    buildSummary(session, currentPhase) {
        switch (currentPhase) {
            case "thesis": {
